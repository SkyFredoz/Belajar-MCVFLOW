...
<body class="bg-gray-100 min-h-screen flex items-center justify-center py-12 px-4">
  ...
  <div class="bg-white shadow-xl rounded-2xl w-full max-w-3xl overflow-hidden">
    
    <div class="px-6 py-5 border-b border-gray-200 flex justify-between items-center">
      <h1 class="text-2xl font-semibold text-gray-900">Daftar Item</h1>
      <button 
        id="openModalButton"
        type="button" 
      ...
      <table class="min-w-full">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
          ...
          <tr class="hover:bg-gray-50 transition-colors duration-150">
            ...
            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">Contoh Item 2</td>
            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
              <a href="#" class="text-indigo-600 hover:text-indigo-900">Edit</a>
              <a href="#" class="text-red-600 hover:text-red-900 ml-4">Hapus</a>
            </td>
  ...
  <script>
    ...
    modal.addEventListener('click', function(event) {
      // Cek apakah yang diklik adalah area latar belakang modal (bukan konten modal)
